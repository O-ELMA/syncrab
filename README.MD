...
* **Type**: Absolute (full) path
* **Description**: The full path of the file or folder that you want to copy somewhere else.

### **Target**

* **Type**: Absolute (full) path
* **Description**: The fill path of the destination folder where the source file/folder will be copied to.
